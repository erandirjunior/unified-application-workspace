...
export function useRequestForm() {
  ...
  const loadRequest = (req, scenarioId = null, stepIndex = null) => {
    setForm({
      ...
      mode: req.mode || INITIAL_FORM.mode,
      workers: req.workers ?? INITIAL_FORM.workers,
      captureBody: req.captureBody ?? INITIAL_FORM.captureBody,
