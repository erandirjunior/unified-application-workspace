          ...
          <div key={workflow.id} className="p-6 bg-white dark:bg-slate-800/40 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm group">
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => onEditWorkflow(workflow.id)} className="p-2 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors" title={t.collection?.tooltips?.edit || "Editar"}>
                ...
                <button 
                  ...
                  title={t.collection?.tooltips?.delete || "Excluir"}
                >
